...
export const Tooltip = ({ renderContent, children, className }: IProps) => {
  const tooltipClasses = classNames('absolute top-7 left-0 -translate-x-2/4 rounded-lg bg-extralightgray color-textgray p-2 text-xs group-hover:z-50 group-hover:block hidden', className);
